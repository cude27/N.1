...
positive_vocab = ['awesome', 'outstanding', 'fantastic', 'terrific', 'good', 'nice', 'great', ':)','children','help','live','support','welcome','agree','humanitarian','money','accept','family','positive','rights','employee','settlements','home','peace']
negative_vocab = ['bad', 'terrible', 'useless', 'hate', ':(','deportation', 'injuries', 'battling', 'destitute', 'tragedy', 'riotous', 'violence', 'opposition', 'irresponsible', 'Tax', 'selfish', 'notorious', 'roguishc', 'crime']
neutral_vocab = ['movie', 'the', 'sound', 'was', 'is', 'actors', 'did', 'know', 'words', 'not','Solution','Resolve','Bussiness','Politics','Law','Legislation','Fundamental','Basic','Un','Migrant']

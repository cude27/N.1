...
consumer_key = 'ptLKTaD26LFYWtm8i0MgE3oF3' #owner
consumer_secret = '97HZPnkcqOrosqfIocwk46UPk0Q5EKAUdPD789LJHRIK8REhBq'

access_token = '3181396656-NYyk0XY3rQLJUF03xetC364pG4X1CLgvfk0FrSz'
access_token_secret = 'CQsOvI9ehC8ps2fvs1Hg3qmYav2xEt5Py7JPSGFm01bpi'
...
while loop:
    ...
    if int(user_input) == 1:
        ...
        if os.path.isfile('./tweetbykeyword.csv'):
            ...
            #my_csv_file = open('tweetbykeyword.csv', 'w') mac.ver
            my_csv_file = open('tweetbykeyword.csv', mode='w', encoding='utf8')
            field_names = ['Index', 'Keyword', 'Tweets']
            writer = csv.DictWriter(my_csv_file, fieldnames=field_names)
            writer.writeheader()
